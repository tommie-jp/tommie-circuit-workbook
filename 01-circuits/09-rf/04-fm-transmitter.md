...
トランジスタ 1 石だけの**コルピッツ発振回路**を FM 放送帯 (80MHz 前後) で組み、
...
- **タンク**: L1 (170nH、実測でずれる。手巻きコイル) と C1・C2 (コルピッツの
...
f<sub>0</sub> = 1 / (2π√(170nH × 15pF)) **≈ 99.7MHz (約100MHz)**。
...
parts:
  ...
  L1: inductor/axial d12 d16 170n
...
- L1 は太さ 0.6mm のエナメル線を直径 8mm の丸棒に 6 回巻き、両端をブレッド
...
| 確かめること | 期待する値 |
| --- | --- |
| 近くの FM ラジオで受信 | 100MHz 付近 (計算値) の**静かな周波数**でノイズが変わる |
