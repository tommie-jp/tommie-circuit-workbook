...
| # | 題 | 段 | 機種 | 板 |
| --- | --- | --- | --- | --- |
| 1-1 | [SOLT の 9 手順と保存](01-calibration/01-solt.md) | 必須 | H4 | — |
| 1-2 | [校正の 3 点を Smith チャートで確かめる (Open / Short / Load)](01-calibration/02-cal-standards-smith.md) | 必須 | H4 | — |
| 1-3 | [Thru と S21 の 0 dB](01-calibration/03-thru.md) | 必須 | H4 | — |
...
| # | 題 | 段 | 機種 | 板 |
| --- | --- | --- | --- | --- |
| 2-1 | [トレースの形式 — Log Mag / 位相 / Smith / SWR](02-display/01-trace-formats.md) | 必須 | H4 | — |
| 2-2 | [マーカー 4 つと読み方](02-display/02-markers.md) | 必須 | H4 | — |
...
| 3-2 | [並列 (シャント) 治具](03-fixtures/02-shunt-fixture.md) | 必須 | H4 | PF |
| 3-3 | [スルー治具 — 治具だけの S21](03-fixtures/03-thru-fixture.md) | 必須 | H4 | PF |
...
| # | 題 | 段 | 機種 | 板 |
| --- | --- | --- | --- | --- |
| 4-1 | [抵抗 (カーボン・金属皮膜) の \|Z\|](04-components/01-resistor.md) | 必須 | H4 | PF |
| 4-2 | [セラミックコンデンサの SRF と ESL](04-components/02-ceramic-capacitor.md) | 必須 | H4 | PF |
| 4-3 | [電解コンデンサの ESR vs 周波数](04-components/03-electrolytic-capacitor.md) | 必須 | H4 | PF |
| 4-4 | [コイルの SRF と Q](04-components/04-inductor.md) | 必須 | H4 | PF |
| 4-5 | [フェライトビーズ — R と X の交差](04-components/05-ferrite-bead.md) | 必須 | H4 | PF |
...
| # | 題 | 段 | 機種 | 板 |
| --- | --- | --- | --- | --- |
| 5-1 | [ケーブルの S21 と長さ (TDR)](05-transmission-lines/01-cable-length.md) | 必須 | H4 | — |
| 5-2 | [速度係数](05-transmission-lines/02-velocity-factor.md) | 必須 | H4 | — |
| 5-3 | [ケーブルの損失 (1 m、30 / 144 / 430 MHz)](05-transmission-lines/03-cable-loss.md) | 必須 | H4 | — |
...
| # | 題 | 段 | 機種 | 板 |
| --- | --- | --- | --- | --- |
| 6-1 | [LC ローパス (7 次)](06-filters/01-lc-lowpass.md) | 必須 | H4 | PF |
| 6-2 | [LC ハイパス](06-filters/02-lc-highpass.md) | 必須 | H4 | PF |
| 6-3 | [LC バンドパス](06-filters/03-lc-bandpass.md) | 必須 | H4 | PF |
...
| # | 題 | 段 | 機種 | 板 |
| --- | --- | --- | --- | --- |
| 7-1 | [SWR とインピーダンスの読み方](07-antennas/01-swr-impedance-reading.md) | 必須 | H4 | — |
| 7-2 | [ダイポール (144 MHz) の調整](07-antennas/02-dipole-144mhz.md) | 必須 | H4 | — |
| 7-3 | [ホイップ (430 MHz) の共振](07-antennas/03-whip-430mhz.md) | 必須 | H4 | — |
